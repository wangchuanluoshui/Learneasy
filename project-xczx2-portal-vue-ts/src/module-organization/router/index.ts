...
export default [
  {
    ...
    children: [
      // 课程列表
      {
        path: 'course-list-manage',
        component: () => import('../pages/course-manage/course-list-manage.vue')
      },
      {
        path: 'course-list',
      ...
      {
        path: 'user-list',
        component: () => import('../pages/user-manage/user-list.vue')
      },
      // 角色管理
      {
        path: 'role-list',
        component: () => import('../pages/role-manage/role-list.vue')
      },
      // 权限管理
      {
        path: 'menu-list',
        component: () => import('../pages/menu-manage/menu-list.vue')
      }
    ]
  }
]
