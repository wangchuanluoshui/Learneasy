  ...
  <div class="nav-bar">
    <el-tabs class="el-tabs" v-model="activeName" type="border-card" @tab-click="handleClick">
      <el-tab-pane label="网站首页" >
        <a href="http://www.51xuecheng.cn">LearnEasy-C++首</a>
      ...
      <el-tab-pane label="教务教学" name="first">
      ...
      <el-tab-pane label="用户管理" name="fourth">
        <router-link to="/organization/user-list">用户管理</router-link>
        <div class="divider"></div>
        <router-link to="/organization/role-list">角色管理</router-link>
        <div class="divider"></div>
        <router-link to="/organization/menu-list">权限管理</router-link>
        <div class="divider"></div>
        <router-link to="/organization/course-list-manage">课程审核</router-link>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
