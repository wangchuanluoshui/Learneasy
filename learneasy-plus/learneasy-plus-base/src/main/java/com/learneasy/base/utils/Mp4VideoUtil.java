package com.learneasy.base.utils;
...
public class Mp4VideoUtil extends com.learneasy.base.utils.VideoUtil {
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "D:\\软件\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "C:\\Users\\23863\\Desktop\\meizi\\test.avi";
        //转换后mp4文件的名称
        String mp4_name = "test_mp4.mp4";
        //转换后mp4文件的路径
        String mp4_path = "C:\\Users\\23863\\Desktop\\meizi\\test_mp4.mp4";
        //创建工具类对象
