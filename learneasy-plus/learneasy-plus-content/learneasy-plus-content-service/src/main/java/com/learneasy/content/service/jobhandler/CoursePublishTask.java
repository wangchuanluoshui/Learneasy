package com.learneasy.content.service.jobhandler;

import com.learneasy.base.exception.LearnEasyPlusException;
import com.learneasy.content.feignclient.SearchServiceClient;
...
import com.learneasy.messagesdk.service.MessageProcessAbstract;
...
//        saveCourseCache(mqMessage,courseId);
    ...
    private void generateCourseHtml(MqMessage mqMessage,long courseId){
        ...
        if(file == null){
            LearnEasyPlusException.cast("生成的静态页面为空");
        }
        // 将html上传到minio
    ...
    private void saveCourseIndex(MqMessage mqMessage,long courseId){
        ...
        if(!add){
            LearnEasyPlusException.cast("远程调用搜索服务添加课程索引失败");
        }
        //保存第二阶段状态
