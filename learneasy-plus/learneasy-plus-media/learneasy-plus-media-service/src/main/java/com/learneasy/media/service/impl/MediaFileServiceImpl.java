...
import com.learneasy.media.model.dto.QueryMediaParamsDto;
import com.learneasy.media.model.dto.UploadFileParamsDto;
import com.learneasy.media.model.dto.UploadFileResultDto;
import com.learneasy.media.model.po.MediaFiles;
import com.learneasy.media.model.po.MediaProcess;
import com.learneasy.media.service.MediaFileService;
import io.minio.*;
...
public class MediaFileServiceImpl implements MediaFileService {
 ...
 public UploadFileResultDto uploadFile(Long companyId, UploadFileParamsDto uploadFileParamsDto, String localFilePath,String objectName) {
  ...
  if(!result){
   LearnEasyPlusException.cast("上传文件失败");
  }
  //入库文件信息
  MediaFiles mediaFiles = currentProxy.addMediaFilesToDb(companyId, fileMd5, uploadFileParamsDto, bucket_mediafiles, objectName);
  if(mediaFiles==null){
   LearnEasyPlusException.cast("文件上传后保存信息失败");
  }
  //准备返回的对象
  ...
  * @return com.learneasy.media.model.po.MediaFiles
  * @author Mr.M
  */
 @Transactional
