package com.learneasy.search.service.impl;

import com.alibaba.fastjson.JSON;
import com.learneasy.base.exception.LearnEasyPlusException;
import com.learneasy.search.service.IndexService;
...
public class IndexServiceImpl implements IndexService {
 ...
 public Boolean addCourseIndex(String indexName,String id,Object object) {
  ...
  try {
   ...
   e.printStackTrace();
   LearnEasyPlusException.cast("添加索引出错");
  }
 ...
 public Boolean updateCourseIndex(String indexName,String id,Object object) {
  ...
  try {
   ...
   e.printStackTrace();
   LearnEasyPlusException.cast("更新索引出错");
  }
 ...
 public Boolean deleteCourseIndex(String indexName,String id) {
  ...
  try {
   ...
   e.printStackTrace();
   LearnEasyPlusException.cast("删除索引出错");
  }
  //获取响应结果
